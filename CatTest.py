...
def GuiInit():
    ...
    icon = picture.image.load("../pog/icon.jpeg")
...
spoingus =0
finalChar = "none"
mixer.music.load('../pog/music.mp3')
mixer.music.play()
...
startButton = picture.image.load("../pog/startButton.png").convert_alpha()
startYellow = picture.image.load("../pog/startButtonYellow.png").convert_alpha()
notPressSkip = picture.image.load("../pog/notPressedSkip.png").convert_alpha()
pressSkip = picture.image.load("../pog/pressedSkip.png").convert_alpha()
extSecond = font_for_second.render("Test", True , (255 , 255 , 255))
buttonPressed = picture.image.load("../pog/buttonPressed.png").convert_alpha()
buttonUnPressed = picture.image.load("../pog/buttonUnpressed.png").convert_alpha()
submitPressed = picture.image.load("../pog/submitPressed.png").convert_alpha()
submitUnPressed = picture.image.load("../pog/submitUnPressed.png").convert_alpha()
exitButtonNot = picture.image.load("../pog/exitButton2.png").convert_alpha()
exitButton = picture.image.load("../pog/exitButton1.png").convert_alpha()
congrats = font_for_second.render("Congratulations!" , True , (255 , 255 , 255))
bingusPng = picture.image.load("../pog/bingusCat.png").convert_alpha()
...
def endingScreenMerlin():
    ...
    merlinPng = picture.image.load("../pog/merlinCat.png").convert_alpha()
...
def endingScreenFloppa():
    ...
    floppaPng = picture.image.load("../pog/floppaCat.png").convert_alpha()
...
def endingScreenSpoingus():
    ...
    spoingusPng = picture.image.load("../pog/spoingusCat.png").convert_alpha()
...
bt5 = Button(430 , 450 , buttonUnPressed)
def click():
    clickSound = mixer.Sound("effect.mp3")
    clickSound.play()
case = 1
running = True
while case<12:
